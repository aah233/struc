...
class BOX 
{
 ...
 public:
   ...
   friend void Resize    (BOX &, int n);
   friend void Clear     (BOX & B);
   friend real EvalpF	 (const BOX & B, int Index, real BetterUbf);
   void Draw      (const ivector & XLim, int WWidth, char const * color);
   void UnDraw    ();
