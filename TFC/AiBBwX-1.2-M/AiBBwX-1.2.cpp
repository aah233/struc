...
struct CompareBoxes<PBOX>
{
   ...
   {
      return lhs->F.lower() < rhs->F.lower() ||
             (lhs->F.lower() == rhs->F.lower() && lhs->F.upper() < rhs->F.upper());
   }

   static bool equals(const PBOX &a, const PBOX &b)
   {
      bool result = a->F.lower() == b->F.lower() && a->F.upper() == b->F.upper();
      // std::cerr << "equals: (" << a->F.lower() << ", " << a->F.upper() << ") == (" << b->F.lower() << ", " << b->F.upper() << ") -> " << result << std::endl;
      return result;
   }

   static bool less(const PBOX &a, const PBOX &b)
   {
      bool result = (a->F.lower() < b->F.lower()) ||
                    (a->F.lower() == b->F.lower() && a->F.upper() < b->F.upper());
      // std::cerr << "less: (" << a->F.lower() << ", " << a->F.upper() << ") < (" << b->F.lower() << ", " << b->F.upper() << ") -> " << result << std::endl;
      return result;
   }
   ...
   {
      bool result = less(a, b) || equals(a, b);
      // std::cerr << "lessEquals: (" << a->F.lower() << ", " << a->F.upper() << ") <= (" << b->F.lower() << ", " << b->F.upper() << ") -> " << result << std::endl;
      return result;
   }
   ...
   static bool greater(const PBOX &a, const PBOX &b)
   {
      bool result = (a->F.lower() > b->F.lower()) ||
                    (a->F.lower() == b->F.lower() && a->F.upper() > b->F.upper());
      // std::cerr << "greater: (" << a->F.lower() << ", " << a->F.upper() << ") > (" << b->F.lower() << ", " << b->F.upper() << ") -> " << result << std::endl;
      return result;
   }
   ...
   {
      bool result = greater(a, b) || equals(a, b);
      // std::cerr << "greaterEquals: (" << a->F.lower() << ", " << a->F.upper() << ") >= (" << b->F.lower() << ", " << b->F.upper() << ") -> " << result << std::endl;
      return result;
   }
};
