...
struct Comparator<T, std::void_t<decltype(std::declval<T>().lower()), decltype(std::declval<T>().upper())>>
{
    static bool equals(const T &a, const T &b)
    {
       ...
       // std::cerr << "equals: (" << a.lower() << ", " << a.upper() << ") == (" << b.lower() << ", " << b.upper() << ") -> " << result << std::endl;
        return result;
    }
    ...
    static bool less(const T &a, const T &b)
    {
       ...
       // std::cerr << "less: (" << a.lower() << ", " << a.upper() << ") < (" << b.lower() << ", " << b.upper() << ") -> " << result << std::endl;
        return result;
    }
    ...
    static bool lessEquals(const T &a, const T &b)
    {
       ...
       // std::cerr << "lessEquals: (" << a.lower() << ", " << a.upper() << ") <= (" << b.lower() << ", " << b.upper() << ") -> " << result << std::endl;
        return result;
    }
    ...
    {
        bool result = (a.lower() > b.lower()) || (a.lower() == b.lower() && a.upper() > b.upper());
        //std::cerr << "greater: (" << a.lower() << ", " << a.upper() << ") > (" << b.lower() << ", " << b.upper() << ") -> " << result << std::endl;
        return result;
    }
    ...
    static bool greaterEquals(const T &a, const T &b)
    {
        ...
        //std::cerr << "greaterEquals: (" << a.lower() << ", " << a.upper() << ") >= (" << b.lower() << ", " << b.upper() << ") -> " << result << std::endl;
        return result;
    }
};
...
AVLNode<KeyType, ValueType> *AVLTree<KeyType, ValueType>::insertRecursive(AVLNode<KeyType, ValueType> *node, KeyType key, ValueType value)
{
    ...
    if (Comparator<KeyType>::less(key, node->key))
        node->left = insertRecursive(node->left, key, value);
    else if (Comparator<KeyType>::greater(key, node->key))
        node->right = insertRecursive(node->right, key, value);
    else if (Comparator<KeyType>::equals(key, node->key))
    {
