...
/*---------------------------------------------------------------------------*/
template <class T> T Test(const ub :: vector <T> & x) 
{   
...
/*---------------------------------------------------------------------------*/
template <class T> T fKearEx1(const ub :: vector <T> & x) 
{   
 return pow(x(0),2)+pow(x(1),3);
}

/*---------------------------------------------------------------------------*/
template <class T> T fKearEx2(const ub :: vector <T> & x) 
{   
 return 0.25*pow(x(0),2)+x(0)+x(1)+0.25*x(0)*x(1)+0.25*pow(x(1),3);
}

/*---------------------------------------------------------------------------*/
template <class T> T fKearEx6(const ub :: vector <T> & x) 
{   
 return 0.25*pow(x(0),2)+x(0)+x(1)+0.25*x(0)*x(1)+0.5*pow(x(1),2);
}

/*---------------------------------------------------------------------------*/
template <class T> T fGP(const ub :: vector <T> & x) 
{   
...
/*---------------------------------------------------------------------------*/
template <class T> T fTHCB(const ub :: vector <T> & x) 
{ 
 return 2.0 * pow(x[0],2)-1.05 * pow(x(0),4) + 
              pow(x(0),6)/6.0 + x(0)*x(1) + pow(x(1),2);  
}
/*---------------------------------------------------------------------------*/
template <class T> T fSHCB(const ub :: vector <T> & x) 
{
...
/*---------------------------------------------------------------------------*/
template <class T> T fGriew(const ub :: vector <T> & x) 
{
 int d =x.size();
 T sum, prod;
...
/*---------------------------------------------------------------------------*/
template <class T> T fShekel(const ub :: vector <T> & x, int iter) 
{
 int i,j;
...
/*----------------------------------------------------------------------------*/
template <class T> T fH3(const ub :: vector <T> & x) 
{
 int i,j;
...
/*---------------------------------------------------------------------------*/
template <class T> T fH4(const ub :: vector <T> & x) 
{
 int i,j;
 double alpha[4] =  { 1.0,  1.2,  3.0,  3.2};
...
/*---------------------------------------------------------------------------*/
template <class T> T fH6(const ub :: vector <T> & x) 
{
 int i,j;
 double alpha[4] =  {  1.0, 1.2,  3.0,  3.2};
...
/*---------------------------------------------------------------------------*/
template <class T> T fLevy(const ub :: vector <T> & x) 
{
 int d=x.size();
 int i;
...
/*---------------------------------------------------------------------------*/
template <class T> T fLevy13(const ub :: vector <T> & x) 
{
 static T pi = kv::constants<T>::pi();
 T term1, term2, term3;
...
/*---------------------------------------------------------------------------*/
template <class T> T Schubert(const ub :: vector <T> & x) 
{
 int i;
 T sum1, sum2;
...
/*---------------------------------------------------------------------------*/
template <class T> T McCormick(const ub :: vector <T> & x) 
{
...
/*---------------------------------------------------------------------------*/
template <class T> T Rosembrock(const ub :: vector <T> & x) 
{
 int i;
 int d=x.size();
 T sum;
...
/*---------------------------------------------------------------------------*/
template <class T> T Michalewicz(const ub :: vector <T> & x) 
{
 static T pi = kv::constants<T>::pi();
 int i;
 int d=x.size();
...
/*---------------------------------------------------------------------------*/
template <class T> T StybTang(const ub :: vector <T> & x) 
{
 int i;
 int d=x.size();
 T sum;
...
template <class T> T Schaffer2(const ub :: vector <T> & x) 
{
 T fact1, fact2;
...
/*---------------------------------------------------------------------------*/
template <class T> T Rastrigin(const ub :: vector <T> & x) 
{
 static T pi = kv::constants<T>::pi();
 int i,d=x.size();
...
/*---------------------------------------------------------------------------*/
template <class T> T DixonPrice(const ub :: vector <T> & x) 
{
 int i,d=x.size();;
...
/*---------------------------------------------------------------------------*/
template <class T> T Trid(const ub :: vector <T> & x) 
{
 int i,d=x.size();
...
/*---------------------------------------------------------------------------*/
template <class T> T TridDown(const ub :: vector <T> & x)
{
 return -Trid(x);
} 

/*---------------------------------------------------------------------------*/
template <class T> T PortfolioMarkowitz4(const ub :: vector <T> & x) 
{
 int i,j;
...
/*---------------------------------------------------------------------------*/
template <class T> T IvoN10Dens075Dvert20(const ub :: vector <T> & x) 
{
 int i,j;
 double A[11][11] = {
...
/*---------------------------------------------------------------------------*/
template <class T> T IvoN10Dens095Dvert20(const ub :: vector <T> & x) 
{
 int i,j;
 double A[11][11] = {
...
/*---------------------------------------------------------------------------*/
template <class T> T IvoN10Dens1Dvert20(const ub :: vector <T> & x) 
{
 int i,j;
 double A[11][11] = {
...
/*---------------------------------------------------------------------------*/
template <class T> T Ackley(const ub :: vector <T> & x) 
{
 static T pi 		= kv::constants<T>::pi();
 static T c  		= 2.0*pi;
 static double b 	= 0.2;
...
/*---------------------------------------------------------------------------*/
template <class T> T PermDb(const ub :: vector <T> & x) 
{
 static double b = 0.5;
 int i,j;
 int d=x.size();
...
template <class T> T DeVilliersGlasser02(const ub :: vector <T> & x) 
{
 int i;
